defmodule ExcelliCalcWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ExcelliCalcWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ExcelliCalcWeb.Gettext, "errors", msg, opts)
    end
  end
